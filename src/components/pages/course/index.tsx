                          ...
                          <div className="relative overflow-hidden rounded-3xl bg-white px-6 pb-9 pt-16 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                            <div className="border-b border-gray-900/10 pb-12">
                              <VilaValerioCourseForm
                                ...
                                htmlIdToScroll="success-vila-valerio"
                              />
                            </div>
                          </div>
                        </div>
                        <div>
                          <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
                            ...
                            <div className="max-w-xl">
                              <p className="mt-6">
                                Primeiro Módulo – Dia 17 de Setembro, 18:30 às
                                21:30
                              </p>
                              ...
                              <p className="mt-6">
                                Segundo Módulo - Dia 18 de Setembro, 18:30 às
                                21:30
                              </p>
                              <p className="font-semibold">
                              ...
                              <p className="mt-6">
                                Terceiro Módulo Dia 19 de Setembro, 18:30 às
                                22:00 21:30
                              </p>
                              <p className="font-semibold">
