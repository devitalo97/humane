...
export const about: About[] = [
    ...
    },
    {
        ...
        description: "A Humaning utiliza o CIS Assessment, um software de inteligência comportamental rápido, intuitivo e fácil de usar, que economiza tempo e dinheiro na seleção dos candidatos. Fornece grande quantidade de informações do Perfi  Comportamental, como: melhor área de atuação, estilo de liderança, tomada de decisão, adequação atual a função exercida e muito mais. Foi desenvolvido pelo pesquisador e psicanalista Deibson Silva, com o apoio e direcionamento intelectual do PhD em Coaching, Paulo Vieira. O sistema possui laudo de confiabilidade baseado nos estudos do coeficiente alpha de cronbach e é validado pelo Departamento de Estatística da Universidade Federal do Ceará, apresentando um índice de 99% de precisão.",
        thumb: illustration3,
        invert: true
    },
]
